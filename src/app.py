...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming lessons and lap training in the school pool",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["chloe@mergington.edu", "hannah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Perform plays, practice acting, and work on stagecraft",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "jackson@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for competitive math problem solving and contests",
